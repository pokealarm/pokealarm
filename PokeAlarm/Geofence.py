...
class Geofence(object):
    ...
    # Returns True if the point at the given X, Y is inside the polygon, else false
    def contains(self, x, y):
        ...
        # If it is inside the boundary box, use a raycast from the line and toggle for every edge it hits
        inside = False
