...
from PokeAlarm.Utils import get_weather_id, match_items_in_array, get_gender_sym
...
class RaidFilter(BaseFilter):
    ...
    def __init__(self, mgr, name, data, geofences_ref=None):
        ...
        self.park_contains = self.evaluate_attribute(  # f.gp matches e.gp
            ...
            eval_func=GymUtils.match_regex_dict,
            limit=BaseFilter.parse_as_set(GymUtils.create_regex, "park_contains", data),
        )
        ...
        self.old_team = self.evaluate_attribute(  # f.ctis contains m.cti
            ...
            eval_func=operator.contains,
            limit=BaseFilter.parse_as_set(GymUtils.get_team_id, "current_teams", data),
        )
