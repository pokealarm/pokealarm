...
class DiscordAlarm(Alarm):
    ...
    _defaults = {
        ...
        "invasions": {
            ...
            "avatar_url": get_image_url("regular/invasions/<grunt_id_3>.png"),
    ...
    def __init__(self, mgr, settings, max_attempts, static_map_key, signing_secret_key):
    ...
    def create_alert_settings(self, settings, default):
        ...
        alert = {
            ...
            "avatar_url": settings.pop(
                ...
                if use_display_avatar
                else default["avatar_url"],
            ),
